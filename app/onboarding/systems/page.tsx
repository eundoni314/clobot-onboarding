...
const steps: Step[] = [
  ...
  },
  {
    icon: '⏰',
    title: '근태 — 출퇴근 & 유연근무',
    desc: '출퇴근은 사무실 근태단말기(사원증 또는 지문)로 진행합니다.\n유연근무는 출근 8~10시(30분 단위), 코어타임 10~17시 기준이며 금요일은 10~17시로 고정입니다.\n자세한 신청, 진행 방법은 ‘인사/근태 가이드’를 확인해 주세요.',
    links: [{ label: '인사/근태 가이드', url: 'https://clobot.atlassian.net/wiki/spaces/ansdufdj1/pages/2249785410/Bizbox' }],
  },
  {
    icon: '🏢',
    title: '마커스빌딩 출입 · 보안',
    desc: '건물 출입을 위해 1층 관리사무소에서 지문을 등록해 주세요.\n(코어시간 10~17시 방문, "클로봇 직원입니다. 건물 출입 지문 등록하러 왔습니다"라고 말씀)',
    notes: [
